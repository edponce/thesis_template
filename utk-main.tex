...
%\documentclass[thesis, 12pt, roman, onehalfspace, lefttext, centertitle, centerpagenum, noteson]{utk-class}
...
\finalizeAppendix % restores environment settings, required if \makeAppendix is used
