...
% the "DEFAULT DOCUMENT CLASS OPTIONS" section in utk-proposal-class.cls
%   dissertation, thesis
%   12pt, 11pt
...
%\documentclass[notes, thesis]{utk-proposal-class}
\documentclass[notes, dissertation]{utk-proposal-class}
%-----------------------------------------------------------------------------%
